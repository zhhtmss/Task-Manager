  ...
  return (
    <Card
      ...
      style={{
        ...
        backgroundColor: task.backgroundColor || settings.backgroundColor,
        ...
        border:
          task.status === "deleted" ? "1px solid #ffb3b3" : "1px solid #dbeafe",
      }}
      styles={{
        body: {
    ...
    >
      ...
      >
        ...
        <span>
          Status: <Tag color={statusColor()}>{task.status}</Tag>
        </span>
