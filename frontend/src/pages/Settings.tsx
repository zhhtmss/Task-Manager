...
export function Settings() {
  ...
  const { settings, isLoading, isFetching, error, updateSettings } =
    useSettings();
  ...
  const saveSettings = async (values: CardSettings) => {
    try {
      ...
      >
        ...
        >
          <div>
            ...
            >
              Customize the default appearance of task cards
            </p>
          </div>
        ...
        >
            ...
            >
              ...
              <Form.Item
                ...
                rules={[
                  {
                    required: true,
                    message: "Enter description font size",
                  },
                ]}
              >
                <InputNumber
          ...
          >
            ...
            >
              Preview of the current card settings
            </p>
            ...
            >
              ...
              >
                This is how your task card will look with the selected settings.
              </p>

              <p>Created: 17.07.2026</p>
            ...
            >
              ...
              <p>Width: {settings.width}px</p>

              <p>Minimum height: {settings.height}px</p>

              <p>Padding: {settings.padding}px</p>
